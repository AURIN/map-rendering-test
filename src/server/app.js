var modulePath= "/usr/lib/node_modules/"; // XXX
var express = require(modulePath + 'express');
var sprintf = require(modulePath + 'sprintf').sprintf;
var pg = require(modulePath + 'pg');
...
console.log("Request: " + req); // XXX
  ...
  var user = req.param("user", 'gis'); 
  var password = req.param("password", '1p0Rt@L');
